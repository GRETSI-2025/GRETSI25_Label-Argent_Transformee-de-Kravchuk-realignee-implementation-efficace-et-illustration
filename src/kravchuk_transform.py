...
def the_transform(x,thetas = np.linspace(1e-10,np.pi,500),phis = np.linspace(0,2*np.pi,500)):
...
def the_zeros(Kz, N, thetas = np.linspace(1e-10,np.pi,500), phis = np.linspace(0,2*np.pi,500),feedback = False):
